...
st.write("Upload gambar kamu, dan AI (K-Means Clustering) akan mendeteksi 8 warna paling dominan secara otomatis.")
...
if uploaded_file is not None:
    ...
    st.success("✨ Berhasil mengekstrak 8 warna dominan!")
